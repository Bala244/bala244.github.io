...
<nav class="navbar navbar-expand-lg dark fixed-top navbar-light">
   ...
   <div class="container">
     ...
     <div class="collapse navbar-collapse" id="navtoggler">
         <ul class="navbar-nav ml-auto mt-2 mt-lg-0" style="margin-right: 0 !important">
             <li class="nav-item">
...
<section id="home" class="home">
    ...
    <div class="container">
       <div class="banner display-table mt-5" >
            <div class="info-header table-cell">
                
                <!-- Heading Title For Header -->
                <h1 data-aos="fade-right" data-aos-duration="1000"><span>Hey There!</span> <br> <span>I'm</span> Bala <br> <span>Based In India</span></h1>
                ...
                <div class="info-about">
                    ...
                    <div class="profile" >
                        <div class="row" data-aos="fade-left" data-aos-delay="300">
                            ...
                            <div class="col-md-6">
                                <p>Phone: <span>+91 90800 99415</span></p>
                            </div>
...
<section class="resume ptb-100">
           ...
           <div class="col-md-6">
            <div class="my-resume">
                ...
                <div class="resume-item">
                    ...
                    <div class="img-resume">
                        <img src="assets/images/about/edication.jpg" alt="my-history">
                    </div>
            ...
            <div class="my-resume">
                ...
                <div class="resume-item">
                    ...
                    <div class="resume-head">
                       <span class="icon-exp"><i class="fas fa-graduation-cap"></i></span>
                       <div class="content-exper">
                          <h4>VelTech Ranga sanku arts college</h4>
                           <div class="history">Bachelor Degree | India</div>
    ...
    <!--==================================================================== 
                            Start Statistics
    =====================================================================-->
<div class="statistics pt-100 pb-70" style="display: none;">
    <div class="overlay"></div>
    <div class="container">
        <div class="row">
   ...
   <!--==================================================================== 
    ...
    =====================================================================-->
 <section id="portfolio" class="portfolio pt-100 pb-70" style="display: none;">
      <div class="container">
        <div class="row">
        ...
        <div id="filtr-container" class="row">
            ...
            <div class="col-md-6 col-lg-4 filtr-item" data-category="3" data-sort="value">
                <div class="my-work">
                    <div class="image">
                        <img class="img-fliud" src="assets/images/portfolio/item-2.jpg" alt="my-work">
                    </div>
                    <a class="overlay" href="assets/images/portfolio/item-2.jpg">
                        <span class="icon-img"><i class="fas fa-image"></i></span>
                        <div class="info-img">
                            <span>Crearive Design</span>
                            <h5>Branding</h5>
            ...
            <div class="col-md-6 col-lg-4 filtr-item" data-category="2" data-sort="value">
                <div class="my-work">
                    <div class="image">
                        <img class="img-fliud" src="assets/images/portfolio/item-3.jpg" alt="my-work">
                    </div>
                    <a class="overlay" href="assets/images/portfolio/item-3.jpg">
                        <span class="icon-img"><i class="fas fa-image"></i></span>
                        <div class="info-img">
                            <span>Crearive Design</span>
            ...
            <div class="col-md-6 col-lg-4 filtr-item" data-category="3" data-sort="value">
                <div class="my-work">
                    <div class="image">
                        <img class="img-fliud" src="assets/images/portfolio/item-4.jpg" alt="my-work">
                    </div>
                    <a class="overlay" href="assets/images/portfolio/item-4.jpg">
                        <span class="icon-img"><i class="fas fa-image"></i></span>
                        <div class="info-img">
                            <span>Crearive Design</span>
                            <h5>Graphic Desing</h5>
            ...
            <div class="col-md-6 col-lg-4 filtr-item" data-category="2" data-sort="value">
                <div class="my-work">
                    <div class="image">
                        <img class="img-fliud" src="assets/images/portfolio/item-5.jpg" alt="my-work">
                    </div>
                    <a class="overlay" href="assets/images/portfolio/item-5.jpg">
                        <span class="icon-img"><i class="fas fa-image"></i></span>
                        <div class="info-img">
                            <span>Crearive Design</span>
                            <h5>Web Design</h5>
            ...
            <div class="col-md-6 col-lg-4 filtr-item" data-category="1" data-sort="value">
                <div class="my-work">
                    <div class="image">
                        <img class="img-fliud" src="assets/images/portfolio/item-6.jpg" alt="my-work">
                    </div>
                    <a class="overlay" href="assets/images/portfolio/item-6.jpg">
                        <span class="icon-img"><i class="fas fa-image"></i></span>
                        <div class="info-img">
                            <span>Crearive Design</span>
                            <h5>Branding</h5>
...
<section id="contact" class="contact ptb-100">
    ...
    <div class="container">
        ...
        <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                         <div class="contact-item">
                             ...
                             <div class="info-cont">
                                <p>16/25 thirupur kumaran street </p>
                                <p> Vysarpadi, Ch-39</p>
                             </div>
            ...
            <div class="offset-lg-1 col-lg-10">
                    ...
                    <!-- Button Send Message  -->
                    <button type="submit" class="btn-one" name="submit">Send Message</button>
                </form>
    ...
    <script defer src="assets/use.fontawesome.com/releases/v5.0.6/js/all.js"></script>
    <!-- My Custom Js  -->
